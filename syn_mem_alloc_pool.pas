{   Subroutine SYN_MEM_ALLOC_POOL (SIZE,P)
*
*   Allocate memory from the SYN library pool.  It will not be possible to
*   individually deallocate this memory.  The memory will be deallocated when
*   SYN_CLOSE is called.  The start of the new memory will be aligned to the
*   natural alignment of a machine integer.
}
module syn_MEM_ALLOC_POOL;
define syn_mem_alloc_pool;
