...
module syo_addstat;
define syo_addstat_line;
define syo_addstat_char;
%include 'syo2.ins.pas';
{
*******************************************************************************
*
*   Subroutine SYO_ADDSTAT_LINE (CHAN_HANDLE, STAT)
*
...
begin
  ...
  syo_get_line (char_handle, lnum, fnam); {get line number and file name}
...
*******************************************************************************
*
*   Subroutine SYO_ADDSTAT_CHAR (CHAR_H, STAT)
*
...
procedure syo_addstat_char (           {add STAT parms to show line and pnt to char}
  in      char_handle: syo_char_t;     {handle to character to show}
