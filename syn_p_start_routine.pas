{   SYN_P_START_ROUTINE (NAME_STR,NAME_LEN)
*
...
*   written to the synax tree.  SYN_P_END_ROUTINE must be called at the end
...
module syn_p_start_routine;
define syn_p_start_routine;
...
var
  ...
  sf_p: stack_frame_down_p_t;          {points to stack frame for syn tree frame}
...
begin
  ...
  tframe_p := down_p;                  {update pointer to current syn level header}
