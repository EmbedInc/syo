{   SYN_INIT
*
*   Initialize the SYN library.  Other SYN_ calls may only be made after the SYN
*   library is initialized.  The SYN library is uninitialized on wakeup and after
*   a call to SYN_CLOSE.
}
module syn_init;
define syn_init;
...
begin
  ...
  syn_preproc_p := addr(syn_preproc_default); {install default pre-processor}
  ...
  syn_reset;                           {make state ready for calling parse routines}
  end;
