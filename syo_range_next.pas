...
module syo_range_next;
define syo_range_next;
...
var
  line_p: syo_line_p_t;                {points to descriptor for source line}
...
begin
  repeat                               {loop to ignore no characters returned}
    syo_preproc_p^ (line_p, start_char, n_chars); {get next chars from pre-processor}
    until n_chars > 0;
...
%debug;         case v of
%debug; syo_ichar_eol_k: begin
%debug;             writeln;
%debug;             end;
%debug; syo_ichar_eof_k: begin
%debug;             writeln ('**EOF**');
%debug;             end;
%debug; syo_ichar_eod_k: begin
%debug;             writeln ('**EOD**');
%debug;             end;
%debug;           end;
%debug;         end
