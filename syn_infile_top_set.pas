...
retry_file:                            {back here to retry opening input file}
  syn_infile_push (top_fnam, top_fnam_ext, stat); {open first input file}
