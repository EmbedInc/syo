...
module syo_error_print;
define syo_error_syntax;
define syo_error_print;
%include 'syo2.ins.pas';
{
************************************************************************
*
*   Subroutine SYO_ERROR_SYNTAX (SUBSYS, M_NAME, PARMS, N_PARMS)
*
*   Print syntax error and return to the caller.  This routine may only
*   be called after an error re-parse.
}
procedure syo_error_syntax (           {print syntax error message and bomb}
...
*   Show the source line and character, if applicable, of the syntax error.
  ...
  syo_get_char_line (char_h, ichar, cnum, sline, lnum, tnam); {get data about err char}
...
************************************************************************
*
*   Subroutine SYO_ERROR_PRINT (SUBSYS, M_NAME, PARMS, N_PARMS)
*
...
begin
  syo_error_syntax (subsys, m_name, parms, n_parms);
  sys_bomb;
  end;
