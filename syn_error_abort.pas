{   Subroutine SYN_ERROR_ABORT (STAT,STR_H,SUBSYS,MSG_NAME,MSG_PARM,N_PARMS)
*
...
module syn_ERROR_ABORT;
define syn_error_abort;
...
begin
  ...
  syn_error (str_h, subsys, msg_name, msg_parm, n_parms); {print other err messages}
  end;
