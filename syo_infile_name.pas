...
module syo_infile_name;
define syo_infile_name_lnum;
define syo_infile_name_pop;
define syo_infile_name_push;
...
*********************************************************************
*
*   Subroutine SYO_INFILE_NAME_PUSH (FNAM)
*
...
*********************************************************************
*
*   Subroutine SYO_INFILE_NAME_POP
*
*   Pop the logical input file state.  The state will be returned to
*   that before the last SYO_INFILE_NAME_PUSH.  The old input file
*   current line number will not be altered.  Applications may need
*   to call SYO_INFILE_NAME_LNUM to correct the input file line number
...
*********************************************************************
*
*   Subroutine SYO_INFILE_NAME_LNUM (LNUM)
*
