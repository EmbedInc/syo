{   SYO_GET_TAG_STRING (STRING_HANDLE,S)
*
*   Get the actual string associated with a syntax tag.  The string is identified
*   by STRING_HANDLE, which comes from subroutine SYO_GET_TAG.
}
module syo_get_tag_string;
define syo_get_tag_string;
...
var
  curr_c: syo_char_t;                  {descriptor for current character}
