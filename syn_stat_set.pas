...
module syn_stat_set;
define syn_stat_set_syerr;
%include 'syn2.ins.pas';
{
*******************************************************************************
*
*   Subroutine SYN_STAT_SET_SYERR (STAT)
*
...
var
  ...
  char_h: syn_char_t;                  {handle to syntax error character}
...
begin
  ...
  syn_get_err_char (char_h);           {get handle to the syntax error character}
