...
*   SYO_P_START_ROUTINE.  If no tags were written to the tree at or below this
...
module syo_p_end_routine;
define syo_p_end_routine;
...
begin
  ...
  if mflag <> syo_mflag_yes_k then begin {restore state to start of this level ?}
  ...
  if (mflag = syo_mflag_yes_k) and made_tag {check for need to keep this level}
